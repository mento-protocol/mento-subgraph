...
export class Locking__getAccountAndDelegateResult {
  value0: Address;
  value1: Address;
...
export class Locking__getLockResult {
  value0: BigInt;
  value1: BigInt;
...
export class Locking__totalSupplyLineResultInitialStruct extends ethereum.Tuple {
  get start(): BigInt {
...
export class Locking extends ethereum.SmartContract {
  ...
  getAccountAndDelegate(id: BigInt): Locking__getAccountAndDelegateResult {
    ...
    return new Locking__getAccountAndDelegateResult(
      result[0].toAddress(),
      result[1].toAddress(),
    );
  }
  ...
  try_getAccountAndDelegate(
    id: BigInt,
  ): ethereum.CallResult<Locking__getAccountAndDelegateResult> {
    ...
    return ethereum.CallResult.fromValue(
      new Locking__getAccountAndDelegateResult(
        value[0].toAddress(),
        value[1].toAddress(),
      ),
    );
  ...
  getAvailableForWithdraw(account: Address): BigInt {
    let result = super.call(
      ...
      "getAvailableForWithdraw(address):(uint96)",
      [ethereum.Value.fromAddress(account)],
    );
  ...
  getLock(
    ...
    slopePeriod: BigInt,
    cliff: BigInt,
  ): Locking__getLockResult {
    let result = super.call(
      "getLock",
      "getLock(uint96,uint32,uint32):(uint96,uint96)",
      [
    ...
    return new Locking__getLockResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_getLock(
    ...
    slopePeriod: BigInt,
    cliff: BigInt,
  ): ethereum.CallResult<Locking__getLockResult> {
    let result = super.tryCall(
      "getLock",
      "getLock(uint96,uint32,uint32):(uint96,uint96)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Locking__getLockResult(value[0].toBigInt(), value[1].toBigInt()),
    );
  }
  ...
  lock(
    ...
    let result = super.call(
      "lock",
      "lock(address,address,uint96,uint32,uint32):(uint256)",
      [
        ethereum.Value.fromAddress(account),
  ...
  relock(
    ...
    let result = super.call(
      "relock",
      "relock(uint256,address,uint96,uint32,uint32):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(id),
  ...
  totalSupplyLine(): Locking__totalSupplyLineResultInitialStruct {
    let result = super.call(
      "totalSupplyLine",
      "totalSupplyLine():((uint32,uint96,uint96,uint32))",
      [],
    );

    return changetype<Locking__totalSupplyLineResultInitialStruct>(
      result[0].toTuple(),
    );
  }

  try_totalSupplyLine(): ethereum.CallResult<Locking__totalSupplyLineResultInitialStruct> {
    let result = super.tryCall(
      "totalSupplyLine",
      "totalSupplyLine():((uint32,uint96,uint96,uint32))",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<Locking__totalSupplyLineResultInitialStruct>(
        value[0].toTuple(),
      ),
    );
  }
